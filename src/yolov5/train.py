...
def train(hyp, opt, device, callbacks):  # hyp is path/to/hyp.yaml or hyp dictionary
    ...
    with torch_distributed_zero_first(LOCAL_RANK):
        data_dict = data_dict or check_dataset(data, override_path=opt.dataset_mount_path)  # check if None
...
def parse_opt(known=False):
    ...
    # AzureML dataset path
    parser.add_argument('--dataset_mount_path', type=str, default='', help='mounted dataset path in AzureML')

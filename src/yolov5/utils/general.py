...
def check_dataset(data, autodownload=True, override_path=''):
    # DELTATRE: override_path, added option to override path within YAML file
    ...
    # DELTATRE: Added option to override path within YAML file
    if override_path != '':

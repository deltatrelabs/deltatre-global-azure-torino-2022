...
namespace Deltatre.BallDetector.Onnx.Demo.MLModels
{
    ...
    using Model;
    using Abstract;
    public class Yolov5n6Model : YoloModel
    {
        //https://github.com/ultralytics/yolov5/blob/master/models/hub/yolov5n6.yaml
        public override string Name { get; set; } = "Yolov5n6";
        public override string ModelWeightsFilePath { get; set; } = "Assets/ModelWeights/yolov5n6.onnx";
